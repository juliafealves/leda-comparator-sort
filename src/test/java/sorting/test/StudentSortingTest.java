...
//		this.implementation = new InsertionSort<Integer>();
    ...
    public void genericTestSubMatriz(Integer[] array, int left, int right) {
        Integer[] copy1 = {};
        ...
        Arrays.sort(copy1);
        Integer[] copy2 = Arrays.copyOfRange(array, left, right + 1);
        Assert.assertArrayEquals(copy1, copy2);
    }

    @Test
    public void testSort06() {
        this.genericTest(new Integer[]{4, 6, 32, 7, 26, 37, 36, 11, 18, 41, 49});
    }

       @Test
    public void testSort07() {
        genericTestSubMatriz(vetorTamPar, 2, 9);
    }

    @Test
    public void testSort08() {
        genericTestSubMatriz(vetorTamImpar, 5, 10);
    }

    @Test
    public void testSort09() {
        genericTestSubMatriz(vetorValoresIguais, 3, 4);
    }

    @Test
    public void testSort10() {
        genericTestSubMatriz(vetorValoresRepetidos,2 , 6);
    }
}